...
--variations
select cast (count(l_extendedprice) as float)/59986052 selectivity, 0 workers, 'index' as type, '3-10' as batch, 0 parllelmode, 1000000 parallelsetupcost, 6 query, 0 i_q, 0 i_p, 0 i_s, 1 i_e, 0 i_d, 0 v_q, 0 v_s, 0 v_d, 990000 v_e, 0 v_p from lineitem where l_extendedprice > 99500 ;
select cast (count(l_extendedprice) as float)/59986052 selectivity, 0 workers, 'index' as type, '3-10' as batch, 0 parllelmode, 1000000 parallelsetupcost, 6 query, 0 i_q, 0 i_p, 0 i_s, 1 i_e, 0 i_d, 0 v_q, 0 v_s, 0 v_d, 980000 v_e, 0 v_p from lineitem where l_extendedprice > 92500 ;
...
--variations
explain select cast (count(l_extendedprice) as float)/59986052 selectivity, 0 workers, 'index' as type, '3-10' as batch, 0 parllelmode, 1000000 parallelsetupcost, 6 query, 0 i_q, 0 i_p, 0 i_s, 1 i_e, 0 i_d, 0 v_q, 0 v_s, 0 v_d, 990000 v_e, 0 v_p from lineitem where l_extendedprice > 99500 ;
explain select cast (count(l_extendedprice) as float)/59986052 selectivity, 0 workers, 'index' as type, '3-10' as batch, 0 parllelmode, 1000000 parallelsetupcost, 6 query, 0 i_q, 0 i_p, 0 i_s, 1 i_e, 0 i_d, 0 v_q, 0 v_s, 0 v_d, 980000 v_e, 0 v_p from lineitem where l_extendedprice > 92500 ;
...
--l_extendedprice index only, parallelism on
set force_parallel_mode = ON; --turn off workers
set parallel_setup_cost = 1000; --default is 1000

--Q6 vary l_extendedprice
\o | cat - >> /home/ubuntu/export/test5-results.txt
\timing on
select cast (count(l_extendedprice) as float)/59986052 selectivity, 1 workers, 'index' as type, '3-10a' as batch, 1 parllelmode, 1000 parallelsetupcost, 6 query, 0 i_q, 0 i_p, 0 i_s, 1 i_e, 0 i_d, 0 v_q, 0 v_s, 0 v_d, 910000 v_e, 0 v_p from lineitem where l_extendedprice > 91000 ;
select cast (count(l_extendedprice) as float)/59986052 selectivity, 1 workers, 'index' as type, '3-10a' as batch, 1 parllelmode, 1000 parallelsetupcost, 6 query, 0 i_q, 0 i_p, 0 i_s, 1 i_e, 0 i_d, 0 v_q, 0 v_s, 0 v_d, 900000 v_e, 0 v_p from lineitem where l_extendedprice > 90000 ;
select cast (count(l_extendedprice) as float)/59986052 selectivity, 1 workers, 'index' as type, '3-10a' as batch, 1 parllelmode, 1000 parallelsetupcost, 6 query, 0 i_q, 0 i_p, 0 i_s, 1 i_e, 0 i_d, 0 v_q, 0 v_s, 0 v_d, 890000 v_e, 0 v_p from lineitem where l_extendedprice > 89000 ;
\o
\timing off

\o | cat - >> /home/ubuntu/export/test5-explain.txt
explain select cast (count(l_extendedprice) as float)/59986052 selectivity, 1 workers, 'index' as type, '3-10a' as batch, 1 parllelmode, 1000 parallelsetupcost, 6 query, 0 i_q, 0 i_p, 0 i_s, 1 i_e, 0 i_d, 0 v_q, 0 v_s, 0 v_d, 910000 v_e, 0 v_p from lineitem where l_extendedprice > 91000 ;
explain select cast (count(l_extendedprice) as float)/59986052 selectivity, 1 workers, 'index' as type, '3-10a' as batch, 1 parllelmode, 1000 parallelsetupcost, 6 query, 0 i_q, 0 i_p, 0 i_s, 1 i_e, 0 i_d, 0 v_q, 0 v_s, 0 v_d, 900000 v_e, 0 v_p from lineitem where l_extendedprice > 90000 ;
explain select cast (count(l_extendedprice) as float)/59986052 selectivity, 1 workers, 'index' as type, '3-10a' as batch, 1 parllelmode, 1000 parallelsetupcost, 6 query, 0 i_q, 0 i_p, 0 i_s, 1 i_e, 0 i_d, 0 v_q, 0 v_s, 0 v_d, 890000 v_e, 0 v_p from lineitem where l_extendedprice > 89000 ;
...
\o | cat - >> /home/ubuntu/export/test5-results.txt
\timing on
select cast (count(l_extendedprice) as float)/59986052 selectivity, 0 workers, 'index' as type, '4-3' as batch, 1 parllelmode, 1000 parallelsetupcost, 6 query, 0 i_q, 0 i_p, 0 i_s, 1 i_e, 0 i_d, 0 v_q, 0 v_s, 0 v_d, 94000 v_e, 0 v_p from lineitem where l_extendedprice > 92000 ;

--variations
select cast (count(l_extendedprice) as float)/59986052 selectivity, 0 workers, 'index' as type, '4-3' as batch, 1 parllelmode, 1000 parallelsetupcost, 6 query, 0 i_q, 0 i_p, 0 i_s, 1 i_e, 0 i_d, 0 v_q, 0 v_s, 0 v_d, 94000 v_e, 0 v_p from lineitem where l_extendedprice > 92500 ;
select cast (count(l_extendedprice) as float)/59986052 selectivity, 0 workers, 'index' as type, '4-3' as batch, 1 parllelmode, 1000 parallelsetupcost, 6 query, 0 i_q, 0 i_p, 0 i_s, 1 i_e, 0 i_d, 0 v_q, 0 v_s, 0 v_d, 93000 v_e, 0 v_p from lineitem where l_extendedprice > 91500 ;
\o
\timing off

\o | cat - >> /home/ubuntu/export/test5-explain.txt
explain select cast (count(l_extendedprice) as float)/59986052 selectivity, 0 workers, 'index' as type, '4-3' as batch, 1 parllelmode, 1000 parallelsetupcost, 6 query, 0 i_q, 0 i_p, 0 i_s, 1 i_e, 0 i_d, 0 v_q, 0 v_s, 0 v_d, 94000 v_e, 0 v_p from lineitem where l_extendedprice > 92000 ;

--variations
explain select cast (count(l_extendedprice) as float)/59986052 selectivity, 0 workers, 'index' as type, '4-3' as batch, 1 parllelmode, 1000 parallelsetupcost, 6 query, 0 i_q, 0 i_p, 0 i_s, 1 i_e, 0 i_d, 0 v_q, 0 v_s, 0 v_d, 94000 v_e, 0 v_p from lineitem where l_extendedprice > 92500 ;
explain select cast (count(l_extendedprice) as float)/59986052 selectivity, 0 workers, 'index' as type, '4-3' as batch, 1 parllelmode, 1000 parallelsetupcost, 6 query, 0 i_q, 0 i_p, 0 i_s, 1 i_e, 0 i_d, 0 v_q, 0 v_s, 0 v_d, 93000 v_e, 0 v_p from lineitem where l_extendedprice > 91500 ;
\o
...
select cast (count(l_extendedprice) as float)/59986052 selectivity, 0 workers, 'index' as type, '3-15' as batch, 0 parllelmode, 1000000 parallelsetupcost, 14 query, 0 i_q, 0 i_p, 1 i_s, 1 i_e, 0 i_d, 0 v_q, 75000 v_s, 0 v_d, 89000 v_e, 1640000 v_p from lineitem where l_extendedprice > 89000 and l_suppkey < 75000 and l_partkey < 1640000;
select cast (count(l_extendedprice) as float)/59986052 selectivity, 0 workers, 'index' as type, '3-15' as batch, 0 parllelmode, 1000000 parallelsetupcost, 14 query, 0 i_q, 0 i_p, 1 i_s, 1 i_e, 0 i_d, 0 v_q, 75000 v_s, 0 v_d, 90000 v_e, 1700000 v_p from lineitem where l_extendedprice > 90000 and l_suppkey < 75000 and l_partkey < 1700000;
select cast (count(l_extendedprice) as float)/59986052 selectivity, 0 workers, 'index' as type, '3-15' as batch, 0 parllelmode, 1000000 parallelsetupcost, 14 query, 0 i_q, 0 i_p, 1 i_s, 1 i_e, 0 i_d, 0 v_q, 75000 v_s, 0 v_d, 91000 v_e, 1760000 v_p from lineitem where l_extendedprice > 91000 and l_suppkey < 75000 and l_partkey < 1760000;
select cast (count(l_extendedprice) as float)/59986052 selectivity, 0 workers, 'index' as type, '3-15' as batch, 0 parllelmode, 1000000 parallelsetupcost, 14 query, 0 i_q, 0 i_p, 1 i_s, 1 i_e, 0 i_d, 0 v_q, 75000 v_s, 0 v_d, 92000 v_e, 1820000 v_p from lineitem where l_extendedprice > 92000 and l_suppkey < 75000 and l_partkey < 1820000;
select cast (count(l_extendedprice) as float)/59986052 selectivity, 0 workers, 'index' as type, '3-15' as batch, 0 parllelmode, 1000000 parallelsetupcost, 14 query, 0 i_q, 0 i_p, 1 i_s, 1 i_e, 0 i_d, 0 v_q, 75000 v_s, 0 v_d, 93000 v_e, 1880000 v_p from lineitem where l_extendedprice > 93000 and l_suppkey < 75000 and l_partkey < 1880000;
select cast (count(l_extendedprice) as float)/59986052 selectivity, 0 workers, 'index' as type, '3-15' as batch, 0 parllelmode, 1000000 parallelsetupcost, 14 query, 0 i_q, 0 i_p, 1 i_s, 1 i_e, 0 i_d, 0 v_q, 75000 v_s, 0 v_d, 94000 v_e, 1940000 v_p from lineitem where l_extendedprice > 94000 and l_suppkey < 75000 and l_partkey < 1940000;
select cast (count(l_extendedprice) as float)/59986052 selectivity, 0 workers, 'index' as type, '3-15' as batch, 0 parllelmode, 1000000 parallelsetupcost, 14 query, 0 i_q, 0 i_p, 1 i_s, 1 i_e, 0 i_d, 0 v_q, 75000 v_s, 0 v_d, 95000 v_e, 2000000 v_p from lineitem where l_extendedprice > 95000 and l_suppkey < 75000 and l_partkey < 2000000;
...
select cast (count(l_extendedprice) as float)/59986052 selectivity, 0 workers, 'index' as type, '3-15' as batch, 0 parllelmode, 1000000 parallelsetupcost, 14 query, 0 i_q, 0 i_p, 1 i_s, 1 i_e, 0 i_d, 0 v_q, 75000 v_s, 0 v_d, 80000 v_e, 1100000 v_p from lineitem where l_extendedprice > 88500 and l_suppkey < 75000 and l_partkey < 2000000;
select cast (count(l_extendedprice) as float)/59986052 selectivity, 0 workers, 'index' as type, '3-15' as batch, 0 parllelmode, 1000000 parallelsetupcost, 14 query, 0 i_q, 0 i_p, 1 i_s, 1 i_e, 0 i_d, 0 v_q, 75000 v_s, 0 v_d, 80000 v_e, 1100000 v_p from lineitem where l_extendedprice > 88500 and l_suppkey < 75000 and l_partkey < 1880000;
...
\o | cat - >> /home/ubuntu/export/test5-results.txt
\timing on
select cast (count(l_extendedprice) as float)/59986052 selectivity, 1 workers, 'bitmap' as type, '3-32' as batch, 1 parllelmode, 1000 parallelsetupcost, 14 query, 0 i_q, 1 i_p, 0 i_s, 1 i_e, 0 i_d, 0 v_q, 75000 v_s, 0 v_d, 87000 v_e, 1520000 v_p from lineitem where l_extendedprice > 87000 and l_suppkey < 75000 and l_partkey < 1520000;

--variations
select cast (count(l_extendedprice) as float)/59986052 selectivity, 1 workers, 'bitmap' as type, '3-32' as batch, 1 parllelmode, 1000 parallelsetupcost, 14 query, 0 i_q, 1 i_p, 0 i_s, 1 i_e, 0 i_d, 0 v_q, 75000 v_s, 0 v_d, 87000 v_e, 1520000 v_p from lineitem where l_extendedprice > 87500 and l_suppkey < 75000 and l_partkey < 1520000;
select cast (count(l_extendedprice) as float)/59986052 selectivity, 1 workers, 'bitmap' as type, '3-32' as batch, 1 parllelmode, 1000 parallelsetupcost, 14 query, 0 i_q, 1 i_p, 0 i_s, 1 i_e, 0 i_d, 0 v_q, 75000 v_s, 0 v_d, 87000 v_e, 1520000 v_p from lineitem where l_extendedprice > 86500 and l_suppkey < 75000 and l_partkey < 1520000;
select cast (count(l_extendedprice) as float)/59986052 selectivity, 1 workers, 'bitmap' as type, '3-32' as batch, 1 parllelmode, 1000 parallelsetupcost, 14 query, 0 i_q, 1 i_p, 0 i_s, 1 i_e, 0 i_d, 0 v_q, 75000 v_s, 0 v_d, 87000 v_e, 1520000 v_p from lineitem where l_extendedprice > 87500 and l_suppkey < 75000 and l_partkey < 1550000;
select cast (count(l_extendedprice) as float)/59986052 selectivity, 1 workers, 'bitmap' as type, '3-32' as batch, 1 parllelmode, 1000 parallelsetupcost, 14 query, 0 i_q, 1 i_p, 0 i_s, 1 i_e, 0 i_d, 0 v_q, 75000 v_s, 0 v_d, 87000 v_e, 1520000 v_p from lineitem where l_extendedprice > 86500 and l_suppkey < 75000 and l_partkey < 1550000;
\o
\timing off

\o | cat - >> /home/ubuntu/export/test5-explain.txt
explain select cast (count(l_extendedprice) as float)/59986052 selectivity, 1 workers, 'bitmap' as type, '3-32' as batch, 1 parllelmode, 1000 parallelsetupcost, 14 query, 0 i_q, 1 i_p, 0 i_s, 1 i_e, 0 i_d, 0 v_q, 75000 v_s, 0 v_d, 87000 v_e, 1520000 v_p from lineitem where l_extendedprice > 87000 and l_suppkey < 75000 and l_partkey < 1520000;

--variations
explain select cast (count(l_extendedprice) as float)/59986052 selectivity, 1 workers, 'bitmap' as type, '3-32' as batch, 1 parllelmode, 1000 parallelsetupcost, 14 query, 0 i_q, 1 i_p, 0 i_s, 1 i_e, 0 i_d, 0 v_q, 75000 v_s, 0 v_d, 87000 v_e, 1520000 v_p from lineitem where l_extendedprice > 87500 and l_suppkey < 75000 and l_partkey < 1520000;
explain select cast (count(l_extendedprice) as float)/59986052 selectivity, 1 workers, 'bitmap' as type, '3-32' as batch, 1 parllelmode, 1000 parallelsetupcost, 14 query, 0 i_q, 1 i_p, 0 i_s, 1 i_e, 0 i_d, 0 v_q, 75000 v_s, 0 v_d, 87000 v_e, 1520000 v_p from lineitem where l_extendedprice > 86500 and l_suppkey < 75000 and l_partkey < 1520000;
explain select cast (count(l_extendedprice) as float)/59986052 selectivity, 1 workers, 'bitmap' as type, '3-32' as batch, 1 parllelmode, 1000 parallelsetupcost, 14 query, 0 i_q, 1 i_p, 0 i_s, 1 i_e, 0 i_d, 0 v_q, 75000 v_s, 0 v_d, 87000 v_e, 1520000 v_p from lineitem where l_extendedprice > 87500 and l_suppkey < 75000 and l_partkey < 1550000;
explain select cast (count(l_extendedprice) as float)/59986052 selectivity, 1 workers, 'bitmap' as type, '3-32' as batch, 1 parllelmode, 1000 parallelsetupcost, 14 query, 0 i_q, 1 i_p, 0 i_s, 1 i_e, 0 i_d, 0 v_q, 75000 v_s, 0 v_d, 87000 v_e, 1520000 v_p from lineitem where l_extendedprice > 86500 and l_suppkey < 75000 and l_partkey < 1550000;
\o
