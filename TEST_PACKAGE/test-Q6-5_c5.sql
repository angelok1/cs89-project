...
\o | cat - >> /home/ubuntu/export/test5-results.txt
\timing on
select cast (count(l_extendedprice) as float)/59986052 selectivity, 0 workers, 'index' as type, '3-6c' as batch, 0 parllelmode, 1000000 parallelsetupcost, 4 query, 1 i_q, 0 i_p, 0 i_s, 0 i_e, 1 i_d, 2 v_q, 0 v_s, .01 v_d, 0 v_e, 0 v_p from lineitem where l_discount < 0.01 and l_quantity < 2 ;
select cast (count(l_extendedprice) as float)/59986052 selectivity, 0 workers, 'index' as type, '3-6c' as batch, 0 parllelmode, 1000000 parallelsetupcost, 4 query, 1 i_q, 0 i_p, 0 i_s, 0 i_e, 1 i_d, 2 v_q, 0 v_s, .02 v_d, 0 v_e, 0 v_p from lineitem where l_discount < 0.02 and l_quantity < 2 ;
select cast (count(l_extendedprice) as float)/59986052 selectivity, 0 workers, 'index' as type, '3-6c' as batch, 0 parllelmode, 1000000 parallelsetupcost, 4 query, 1 i_q, 0 i_p, 0 i_s, 0 i_e, 1 i_d, 2 v_q, 0 v_s, .03 v_d, 0 v_e, 0 v_p from lineitem where l_discount < 0.03 and l_quantity < 2 ;
select cast (count(l_extendedprice) as float)/59986052 selectivity, 0 workers, 'index' as type, '3-6c' as batch, 0 parllelmode, 1000000 parallelsetupcost, 4 query, 1 i_q, 0 i_p, 0 i_s, 0 i_e, 1 i_d, 2 v_q, 0 v_s, .04 v_d, 0 v_e, 0 v_p from lineitem where l_discount < 0.04 and l_quantity < 2 ;
select cast (count(l_extendedprice) as float)/59986052 selectivity, 0 workers, 'index' as type, '3-6c' as batch, 0 parllelmode, 1000000 parallelsetupcost, 4 query, 1 i_q, 0 i_p, 0 i_s, 0 i_e, 1 i_d, 2 v_q, 0 v_s, .05 v_d, 0 v_e, 0 v_p from lineitem where l_discount < 0.05 and l_quantity < 2 ;
select cast (count(l_extendedprice) as float)/59986052 selectivity, 0 workers, 'index' as type, '3-6c' as batch, 0 parllelmode, 1000000 parallelsetupcost, 4 query, 1 i_q, 0 i_p, 0 i_s, 0 i_e, 1 i_d, 2 v_q, 0 v_s, .06 v_d, 0 v_e, 0 v_p from lineitem where l_discount < 0.06 and l_quantity < 2 ;
select cast (count(l_extendedprice) as float)/59986052 selectivity, 0 workers, 'index' as type, '3-6c' as batch, 0 parllelmode, 1000000 parallelsetupcost, 4 query, 1 i_q, 0 i_p, 0 i_s, 0 i_e, 1 i_d, 2 v_q, 0 v_s, .07 v_d, 0 v_e, 0 v_p from lineitem where l_discount < 0.07 and l_quantity < 2 ;
select cast (count(l_extendedprice) as float)/59986052 selectivity, 0 workers, 'index' as type, '3-6c' as batch, 0 parllelmode, 1000000 parallelsetupcost, 4 query, 1 i_q, 0 i_p, 0 i_s, 0 i_e, 1 i_d, 2 v_q, 0 v_s, .08 v_d, 0 v_e, 0 v_p from lineitem where l_discount < 0.08 and l_quantity < 2 ;
select cast (count(l_extendedprice) as float)/59986052 selectivity, 0 workers, 'index' as type, '3-6c' as batch, 0 parllelmode, 1000000 parallelsetupcost, 4 query, 1 i_q, 0 i_p, 0 i_s, 0 i_e, 1 i_d, 2 v_q, 0 v_s, .09 v_d, 0 v_e, 0 v_p from lineitem where l_discount < 0.09 and l_quantity < 2 ;
...
select cast (count(l_extendedprice) as float)/59986052 selectivity, 0 workers, 'index' as type, '3-6c' as batch, 0 parllelmode, 1000000 parallelsetupcost, 4 query, 1 i_q, 0 i_p, 0 i_s, 0 i_e, 1 i_d, 2 v_q, 0 v_s, .12 v_d, 0 v_e, 0 v_p from lineitem where l_discount < 0.12 and l_quantity < 2 ;
select cast (count(l_extendedprice) as float)/59986052 selectivity, 0 workers, 'index' as type, '3-6c' as batch, 0 parllelmode, 1000000 parallelsetupcost, 4 query, 1 i_q, 0 i_p, 0 i_s, 0 i_e, 1 i_d, 2 v_q, 0 v_s, .13 v_d, 0 v_e, 0 v_p from lineitem where l_discount < 0.13 and l_quantity < 2 ;
select cast (count(l_extendedprice) as float)/59986052 selectivity, 0 workers, 'index' as type, '3-6c' as batch, 0 parllelmode, 1000000 parallelsetupcost, 4 query, 1 i_q, 0 i_p, 0 i_s, 0 i_e, 1 i_d, 2 v_q, 0 v_s, .14 v_d, 0 v_e, 0 v_p from lineitem where l_discount < 0.14 and l_quantity < 2 ;
select cast (count(l_extendedprice) as float)/59986052 selectivity, 0 workers, 'index' as type, '3-6c' as batch, 0 parllelmode, 1000000 parallelsetupcost, 4 query, 1 i_q, 0 i_p, 0 i_s, 0 i_e, 1 i_d, 2 v_q, 0 v_s, .15 v_d, 0 v_e, 0 v_p from lineitem where l_discount < 0.15 and l_quantity < 2 ;
...
--variations
select cast (count(l_extendedprice) as float)/59986052 selectivity, 0 workers, 'index' as type, '3-6c' as batch, 0 parllelmode, 1000000 parallelsetupcost, 4 query, 1 i_q, 0 i_p, 0 i_s, 0 i_e, 1 i_d, 2 v_q, 0 v_s, .01 v_d, 0 v_e, 0 v_p from lineitem where l_discount < 0.015 and l_quantity < 2 ;
select cast (count(l_extendedprice) as float)/59986052 selectivity, 0 workers, 'index' as type, '3-6c' as batch, 0 parllelmode, 1000000 parallelsetupcost, 4 query, 1 i_q, 0 i_p, 0 i_s, 0 i_e, 1 i_d, 2 v_q, 0 v_s, .02 v_d, 0 v_e, 0 v_p from lineitem where l_discount < 0.025 and l_quantity < 2 ;
select cast (count(l_extendedprice) as float)/59986052 selectivity, 0 workers, 'index' as type, '3-6c' as batch, 0 parllelmode, 1000000 parallelsetupcost, 4 query, 1 i_q, 0 i_p, 0 i_s, 0 i_e, 1 i_d, 2 v_q, 0 v_s, .03 v_d, 0 v_e, 0 v_p from lineitem where l_discount < 0.035 and l_quantity < 2 ;
select cast (count(l_extendedprice) as float)/59986052 selectivity, 0 workers, 'index' as type, '3-6c' as batch, 0 parllelmode, 1000000 parallelsetupcost, 4 query, 1 i_q, 0 i_p, 0 i_s, 0 i_e, 1 i_d, 2 v_q, 0 v_s, .04 v_d, 0 v_e, 0 v_p from lineitem where l_discount < 0.045 and l_quantity < 2 ;
select cast (count(l_extendedprice) as float)/59986052 selectivity, 0 workers, 'index' as type, '3-6c' as batch, 0 parllelmode, 1000000 parallelsetupcost, 4 query, 1 i_q, 0 i_p, 0 i_s, 0 i_e, 1 i_d, 2 v_q, 0 v_s, .05 v_d, 0 v_e, 0 v_p from lineitem where l_discount < 0.055 and l_quantity < 2 ;
select cast (count(l_extendedprice) as float)/59986052 selectivity, 0 workers, 'index' as type, '3-6c' as batch, 0 parllelmode, 1000000 parallelsetupcost, 4 query, 1 i_q, 0 i_p, 0 i_s, 0 i_e, 1 i_d, 2 v_q, 0 v_s, .06 v_d, 0 v_e, 0 v_p from lineitem where l_discount < 0.065 and l_quantity < 2 ;
select cast (count(l_extendedprice) as float)/59986052 selectivity, 0 workers, 'index' as type, '3-6c' as batch, 0 parllelmode, 1000000 parallelsetupcost, 4 query, 1 i_q, 0 i_p, 0 i_s, 0 i_e, 1 i_d, 2 v_q, 0 v_s, .07 v_d, 0 v_e, 0 v_p from lineitem where l_discount < 0.075 and l_quantity < 2 ;
select cast (count(l_extendedprice) as float)/59986052 selectivity, 0 workers, 'index' as type, '3-6c' as batch, 0 parllelmode, 1000000 parallelsetupcost, 4 query, 1 i_q, 0 i_p, 0 i_s, 0 i_e, 1 i_d, 2 v_q, 0 v_s, .08 v_d, 0 v_e, 0 v_p from lineitem where l_discount < 0.085 and l_quantity < 2 ;
...
select cast (count(l_extendedprice) as float)/59986052 selectivity, 0 workers, 'index' as type, '3-6c' as batch, 0 parllelmode, 1000000 parallelsetupcost, 4 query, 1 i_q, 0 i_p, 0 i_s, 0 i_e, 1 i_d, 2 v_q, 0 v_s, .10 v_d, 0 v_e, 0 v_p from lineitem where l_discount < 0.105 and l_quantity < 2 ;
select cast (count(l_extendedprice) as float)/59986052 selectivity, 0 workers, 'index' as type, '3-6c' as batch, 0 parllelmode, 1000000 parallelsetupcost, 4 query, 1 i_q, 0 i_p, 0 i_s, 0 i_e, 1 i_d, 2 v_q, 0 v_s, .11 v_d, 0 v_e, 0 v_p from lineitem where l_discount < 0.115 and l_quantity < 2 ;
select cast (count(l_extendedprice) as float)/59986052 selectivity, 0 workers, 'index' as type, '3-6c' as batch, 0 parllelmode, 1000000 parallelsetupcost, 4 query, 1 i_q, 0 i_p, 0 i_s, 0 i_e, 1 i_d, 2 v_q, 0 v_s, .12 v_d, 0 v_e, 0 v_p from lineitem where l_discount < 0.125 and l_quantity < 2 ;
select cast (count(l_extendedprice) as float)/59986052 selectivity, 0 workers, 'index' as type, '3-6c' as batch, 0 parllelmode, 1000000 parallelsetupcost, 4 query, 1 i_q, 0 i_p, 0 i_s, 0 i_e, 1 i_d, 2 v_q, 0 v_s, .13 v_d, 0 v_e, 0 v_p from lineitem where l_discount < 0.135 and l_quantity < 2 ;
select cast (count(l_extendedprice) as float)/59986052 selectivity, 0 workers, 'index' as type, '3-6c' as batch, 0 parllelmode, 1000000 parallelsetupcost, 4 query, 1 i_q, 0 i_p, 0 i_s, 0 i_e, 1 i_d, 2 v_q, 0 v_s, .14 v_d, 0 v_e, 0 v_p from lineitem where l_discount < 0.145 and l_quantity < 2 ;
select cast (count(l_extendedprice) as float)/59986052 selectivity, 0 workers, 'index' as type, '3-6c' as batch, 0 parllelmode, 1000000 parallelsetupcost, 4 query, 1 i_q, 0 i_p, 0 i_s, 0 i_e, 1 i_d, 2 v_q, 0 v_s, .15 v_d, 0 v_e, 0 v_p from lineitem where l_discount < 0.155 and l_quantity < 2 ;
\o
\timing off

\o | cat - >> /home/ubuntu/export/test5-explain.txt
explain select cast (count(l_extendedprice) as float)/59986052 selectivity, 0 workers, 'index' as type, '3-6c' as batch, 0 parllelmode, 1000000 parallelsetupcost, 4 query, 1 i_q, 0 i_p, 0 i_s, 0 i_e, 1 i_d, 2 v_q, 0 v_s, .01 v_d, 0 v_e, 0 v_p from lineitem where l_discount < 0.01 and l_quantity < 2 ;
explain select cast (count(l_extendedprice) as float)/59986052 selectivity, 0 workers, 'index' as type, '3-6c' as batch, 0 parllelmode, 1000000 parallelsetupcost, 4 query, 1 i_q, 0 i_p, 0 i_s, 0 i_e, 1 i_d, 2 v_q, 0 v_s, .02 v_d, 0 v_e, 0 v_p from lineitem where l_discount < 0.02 and l_quantity < 2 ;
explain select cast (count(l_extendedprice) as float)/59986052 selectivity, 0 workers, 'index' as type, '3-6c' as batch, 0 parllelmode, 1000000 parallelsetupcost, 4 query, 1 i_q, 0 i_p, 0 i_s, 0 i_e, 1 i_d, 2 v_q, 0 v_s, .03 v_d, 0 v_e, 0 v_p from lineitem where l_discount < 0.03 and l_quantity < 2 ;
explain select cast (count(l_extendedprice) as float)/59986052 selectivity, 0 workers, 'index' as type, '3-6c' as batch, 0 parllelmode, 1000000 parallelsetupcost, 4 query, 1 i_q, 0 i_p, 0 i_s, 0 i_e, 1 i_d, 2 v_q, 0 v_s, .04 v_d, 0 v_e, 0 v_p from lineitem where l_discount < 0.04 and l_quantity < 2 ;
explain select cast (count(l_extendedprice) as float)/59986052 selectivity, 0 workers, 'index' as type, '3-6c' as batch, 0 parllelmode, 1000000 parallelsetupcost, 4 query, 1 i_q, 0 i_p, 0 i_s, 0 i_e, 1 i_d, 2 v_q, 0 v_s, .05 v_d, 0 v_e, 0 v_p from lineitem where l_discount < 0.05 and l_quantity < 2 ;
explain select cast (count(l_extendedprice) as float)/59986052 selectivity, 0 workers, 'index' as type, '3-6c' as batch, 0 parllelmode, 1000000 parallelsetupcost, 4 query, 1 i_q, 0 i_p, 0 i_s, 0 i_e, 1 i_d, 2 v_q, 0 v_s, .06 v_d, 0 v_e, 0 v_p from lineitem where l_discount < 0.06 and l_quantity < 2 ;
explain select cast (count(l_extendedprice) as float)/59986052 selectivity, 0 workers, 'index' as type, '3-6c' as batch, 0 parllelmode, 1000000 parallelsetupcost, 4 query, 1 i_q, 0 i_p, 0 i_s, 0 i_e, 1 i_d, 2 v_q, 0 v_s, .07 v_d, 0 v_e, 0 v_p from lineitem where l_discount < 0.07 and l_quantity < 2 ;
explain select cast (count(l_extendedprice) as float)/59986052 selectivity, 0 workers, 'index' as type, '3-6c' as batch, 0 parllelmode, 1000000 parallelsetupcost, 4 query, 1 i_q, 0 i_p, 0 i_s, 0 i_e, 1 i_d, 2 v_q, 0 v_s, .08 v_d, 0 v_e, 0 v_p from lineitem where l_discount < 0.08 and l_quantity < 2 ;
explain select cast (count(l_extendedprice) as float)/59986052 selectivity, 0 workers, 'index' as type, '3-6c' as batch, 0 parllelmode, 1000000 parallelsetupcost, 4 query, 1 i_q, 0 i_p, 0 i_s, 0 i_e, 1 i_d, 2 v_q, 0 v_s, .09 v_d, 0 v_e, 0 v_p from lineitem where l_discount < 0.09 and l_quantity < 2 ;
...
explain select cast (count(l_extendedprice) as float)/59986052 selectivity, 0 workers, 'index' as type, '3-6c' as batch, 0 parllelmode, 1000000 parallelsetupcost, 4 query, 1 i_q, 0 i_p, 0 i_s, 0 i_e, 1 i_d, 2 v_q, 0 v_s, .12 v_d, 0 v_e, 0 v_p from lineitem where l_discount < 0.12 and l_quantity < 2 ;
explain select cast (count(l_extendedprice) as float)/59986052 selectivity, 0 workers, 'index' as type, '3-6c' as batch, 0 parllelmode, 1000000 parallelsetupcost, 4 query, 1 i_q, 0 i_p, 0 i_s, 0 i_e, 1 i_d, 2 v_q, 0 v_s, .13 v_d, 0 v_e, 0 v_p from lineitem where l_discount < 0.13 and l_quantity < 2 ;
explain select cast (count(l_extendedprice) as float)/59986052 selectivity, 0 workers, 'index' as type, '3-6c' as batch, 0 parllelmode, 1000000 parallelsetupcost, 4 query, 1 i_q, 0 i_p, 0 i_s, 0 i_e, 1 i_d, 2 v_q, 0 v_s, .14 v_d, 0 v_e, 0 v_p from lineitem where l_discount < 0.14 and l_quantity < 2 ;
explain select cast (count(l_extendedprice) as float)/59986052 selectivity, 0 workers, 'index' as type, '3-6c' as batch, 0 parllelmode, 1000000 parallelsetupcost, 4 query, 1 i_q, 0 i_p, 0 i_s, 0 i_e, 1 i_d, 2 v_q, 0 v_s, .15 v_d, 0 v_e, 0 v_p from lineitem where l_discount < 0.15 and l_quantity < 2 ;
...
--variations
explain select cast (count(l_extendedprice) as float)/59986052 selectivity, 0 workers, 'index' as type, '3-6c' as batch, 0 parllelmode, 1000000 parallelsetupcost, 4 query, 1 i_q, 0 i_p, 0 i_s, 0 i_e, 1 i_d, 2 v_q, 0 v_s, .01 v_d, 0 v_e, 0 v_p from lineitem where l_discount < 0.015 and l_quantity < 2 ;
explain select cast (count(l_extendedprice) as float)/59986052 selectivity, 0 workers, 'index' as type, '3-6c' as batch, 0 parllelmode, 1000000 parallelsetupcost, 4 query, 1 i_q, 0 i_p, 0 i_s, 0 i_e, 1 i_d, 2 v_q, 0 v_s, .02 v_d, 0 v_e, 0 v_p from lineitem where l_discount < 0.025 and l_quantity < 2 ;
explain select cast (count(l_extendedprice) as float)/59986052 selectivity, 0 workers, 'index' as type, '3-6c' as batch, 0 parllelmode, 1000000 parallelsetupcost, 4 query, 1 i_q, 0 i_p, 0 i_s, 0 i_e, 1 i_d, 2 v_q, 0 v_s, .03 v_d, 0 v_e, 0 v_p from lineitem where l_discount < 0.035 and l_quantity < 2 ;
explain select cast (count(l_extendedprice) as float)/59986052 selectivity, 0 workers, 'index' as type, '3-6c' as batch, 0 parllelmode, 1000000 parallelsetupcost, 4 query, 1 i_q, 0 i_p, 0 i_s, 0 i_e, 1 i_d, 2 v_q, 0 v_s, .04 v_d, 0 v_e, 0 v_p from lineitem where l_discount < 0.045 and l_quantity < 2 ;
explain select cast (count(l_extendedprice) as float)/59986052 selectivity, 0 workers, 'index' as type, '3-6c' as batch, 0 parllelmode, 1000000 parallelsetupcost, 4 query, 1 i_q, 0 i_p, 0 i_s, 0 i_e, 1 i_d, 2 v_q, 0 v_s, .05 v_d, 0 v_e, 0 v_p from lineitem where l_discount < 0.055 and l_quantity < 2 ;
explain select cast (count(l_extendedprice) as float)/59986052 selectivity, 0 workers, 'index' as type, '3-6c' as batch, 0 parllelmode, 1000000 parallelsetupcost, 4 query, 1 i_q, 0 i_p, 0 i_s, 0 i_e, 1 i_d, 2 v_q, 0 v_s, .06 v_d, 0 v_e, 0 v_p from lineitem where l_discount < 0.065 and l_quantity < 2 ;
explain select cast (count(l_extendedprice) as float)/59986052 selectivity, 0 workers, 'index' as type, '3-6c' as batch, 0 parllelmode, 1000000 parallelsetupcost, 4 query, 1 i_q, 0 i_p, 0 i_s, 0 i_e, 1 i_d, 2 v_q, 0 v_s, .07 v_d, 0 v_e, 0 v_p from lineitem where l_discount < 0.075 and l_quantity < 2 ;
explain select cast (count(l_extendedprice) as float)/59986052 selectivity, 0 workers, 'index' as type, '3-6c' as batch, 0 parllelmode, 1000000 parallelsetupcost, 4 query, 1 i_q, 0 i_p, 0 i_s, 0 i_e, 1 i_d, 2 v_q, 0 v_s, .08 v_d, 0 v_e, 0 v_p from lineitem where l_discount < 0.085 and l_quantity < 2 ;
...
explain select cast (count(l_extendedprice) as float)/59986052 selectivity, 0 workers, 'index' as type, '3-6c' as batch, 0 parllelmode, 1000000 parallelsetupcost, 4 query, 1 i_q, 0 i_p, 0 i_s, 0 i_e, 1 i_d, 2 v_q, 0 v_s, .10 v_d, 0 v_e, 0 v_p from lineitem where l_discount < 0.105 and l_quantity < 2 ;
explain select cast (count(l_extendedprice) as float)/59986052 selectivity, 0 workers, 'index' as type, '3-6c' as batch, 0 parllelmode, 1000000 parallelsetupcost, 4 query, 1 i_q, 0 i_p, 0 i_s, 0 i_e, 1 i_d, 2 v_q, 0 v_s, .11 v_d, 0 v_e, 0 v_p from lineitem where l_discount < 0.115 and l_quantity < 2 ;
explain select cast (count(l_extendedprice) as float)/59986052 selectivity, 0 workers, 'index' as type, '3-6c' as batch, 0 parllelmode, 1000000 parallelsetupcost, 4 query, 1 i_q, 0 i_p, 0 i_s, 0 i_e, 1 i_d, 2 v_q, 0 v_s, .12 v_d, 0 v_e, 0 v_p from lineitem where l_discount < 0.125 and l_quantity < 2 ;
explain select cast (count(l_extendedprice) as float)/59986052 selectivity, 0 workers, 'index' as type, '3-6c' as batch, 0 parllelmode, 1000000 parallelsetupcost, 4 query, 1 i_q, 0 i_p, 0 i_s, 0 i_e, 1 i_d, 2 v_q, 0 v_s, .13 v_d, 0 v_e, 0 v_p from lineitem where l_discount < 0.135 and l_quantity < 2 ;
explain select cast (count(l_extendedprice) as float)/59986052 selectivity, 0 workers, 'index' as type, '3-6c' as batch, 0 parllelmode, 1000000 parallelsetupcost, 4 query, 1 i_q, 0 i_p, 0 i_s, 0 i_e, 1 i_d, 2 v_q, 0 v_s, .14 v_d, 0 v_e, 0 v_p from lineitem where l_discount < 0.145 and l_quantity < 2 ;
explain select cast (count(l_extendedprice) as float)/59986052 selectivity, 0 workers, 'index' as type, '3-6c' as batch, 0 parllelmode, 1000000 parallelsetupcost, 4 query, 1 i_q, 0 i_p, 0 i_s, 0 i_e, 1 i_d, 2 v_q, 0 v_s, .15 v_d, 0 v_e, 0 v_p from lineitem where l_discount < 0.155 and l_quantity < 2 ;
\o
...
--variations
select cast (count(l_extendedprice) as float)/59986052 selectivity, 0 workers, 'index' as type, '3-10' as batch, 0 parllelmode, 1000000 parallelsetupcost, 6 query, 0 i_q, 0 i_p, 0 i_s, 1 i_e, 0 i_d, 0 v_q, 0 v_s, 0 v_d, 980000 v_e, 0 v_p from lineitem where l_extendedprice > 98500 ;
select cast (count(l_extendedprice) as float)/59986052 selectivity, 0 workers, 'index' as type, '3-10' as batch, 0 parllelmode, 1000000 parallelsetupcost, 6 query, 0 i_q, 0 i_p, 0 i_s, 1 i_e, 0 i_d, 0 v_q, 0 v_s, 0 v_d, 920000 v_e, 0 v_p from lineitem where l_extendedprice > 92045 ;
select cast (count(l_extendedprice) as float)/59986052 selectivity, 0 workers, 'index' as type, '3-10' as batch, 0 parllelmode, 1000000 parallelsetupcost, 6 query, 0 i_q, 0 i_p, 0 i_s, 1 i_e, 0 i_d, 0 v_q, 0 v_s, 0 v_d, 910000 v_e, 0 v_p from lineitem where l_extendedprice > 91500 ;
select cast (count(l_extendedprice) as float)/59986052 selectivity, 0 workers, 'index' as type, '3-10' as batch, 0 parllelmode, 1000000 parallelsetupcost, 6 query, 0 i_q, 0 i_p, 0 i_s, 1 i_e, 0 i_d, 0 v_q, 0 v_s, 0 v_d, 900000 v_e, 0 v_p from lineitem where l_extendedprice > 90750 ;
select cast (count(l_extendedprice) as float)/59986052 selectivity, 0 workers, 'index' as type, '3-10' as batch, 0 parllelmode, 1000000 parallelsetupcost, 6 query, 0 i_q, 0 i_p, 0 i_s, 1 i_e, 0 i_d, 0 v_q, 0 v_s, 0 v_d, 900000 v_e, 0 v_p from lineitem where l_extendedprice > 89750 ;
...
--variations
explain select cast (count(l_extendedprice) as float)/59986052 selectivity, 0 workers, 'index' as type, '3-10' as batch, 0 parllelmode, 1000000 parallelsetupcost, 6 query, 0 i_q, 0 i_p, 0 i_s, 1 i_e, 0 i_d, 0 v_q, 0 v_s, 0 v_d, 980000 v_e, 0 v_p from lineitem where l_extendedprice > 98500 ;
explain select cast (count(l_extendedprice) as float)/59986052 selectivity, 0 workers, 'index' as type, '3-10' as batch, 0 parllelmode, 1000000 parallelsetupcost, 6 query, 0 i_q, 0 i_p, 0 i_s, 1 i_e, 0 i_d, 0 v_q, 0 v_s, 0 v_d, 920000 v_e, 0 v_p from lineitem where l_extendedprice > 92045 ;
explain select cast (count(l_extendedprice) as float)/59986052 selectivity, 0 workers, 'index' as type, '3-10' as batch, 0 parllelmode, 1000000 parallelsetupcost, 6 query, 0 i_q, 0 i_p, 0 i_s, 1 i_e, 0 i_d, 0 v_q, 0 v_s, 0 v_d, 910000 v_e, 0 v_p from lineitem where l_extendedprice > 91500 ;
explain select cast (count(l_extendedprice) as float)/59986052 selectivity, 0 workers, 'index' as type, '3-10' as batch, 0 parllelmode, 1000000 parallelsetupcost, 6 query, 0 i_q, 0 i_p, 0 i_s, 1 i_e, 0 i_d, 0 v_q, 0 v_s, 0 v_d, 900000 v_e, 0 v_p from lineitem where l_extendedprice > 90750 ;
explain select cast (count(l_extendedprice) as float)/59986052 selectivity, 0 workers, 'index' as type, '3-10' as batch, 0 parllelmode, 1000000 parallelsetupcost, 6 query, 0 i_q, 0 i_p, 0 i_s, 1 i_e, 0 i_d, 0 v_q, 0 v_s, 0 v_d, 900000 v_e, 0 v_p from lineitem where l_extendedprice > 89750 ;
...
\o | cat - >> /home/ubuntu/export/test5-results.txt
\timing on
select cast (count(l_extendedprice) as float)/59986052 selectivity, 0 workers, 'index' as type, '4-2' as batch, 1 parllelmode, 1000 parallelsetupcost, 6 query, 0 i_q, 0 i_p, 0 i_s, 0 i_e, 0 i_d, 0 v_q, 0 v_s, 0 v_d, 100000 v_e, 0 v_p from lineitem where l_extendedprice > 100000 ;
select cast (count(l_extendedprice) as float)/59986052 selectivity, 0 workers, 'index' as type, '4-2' as batch, 1 parllelmode, 1000 parallelsetupcost, 6 query, 0 i_q, 0 i_p, 0 i_s, 0 i_e, 0 i_d, 0 v_q, 0 v_s, 0 v_d, 99000 v_e, 0 v_p from lineitem where l_extendedprice > 99000 ;
select cast (count(l_extendedprice) as float)/59986052 selectivity, 0 workers, 'index' as type, '4-2' as batch, 1 parllelmode, 1000 parallelsetupcost, 6 query, 0 i_q, 0 i_p, 0 i_s, 0 i_e, 0 i_d, 0 v_q, 0 v_s, 0 v_d, 97000 v_e, 0 v_p from lineitem where l_extendedprice > 97000 ;
select cast (count(l_extendedprice) as float)/59986052 selectivity, 0 workers, 'index' as type, '4-2' as batch, 1 parllelmode, 1000 parallelsetupcost, 6 query, 0 i_q, 0 i_p, 0 i_s, 0 i_e, 0 i_d, 0 v_q, 0 v_s, 0 v_d, 96000 v_e, 0 v_p from lineitem where l_extendedprice > 96000 ;
select cast (count(l_extendedprice) as float)/59986052 selectivity, 0 workers, 'index' as type, '4-2' as batch, 1 parllelmode, 1000 parallelsetupcost, 6 query, 0 i_q, 0 i_p, 0 i_s, 0 i_e, 0 i_d, 0 v_q, 0 v_s, 0 v_d, 96000 v_e, 0 v_p from lineitem where l_extendedprice > 95000 ;
--variations
select cast (count(l_extendedprice) as float)/59986052 selectivity, 0 workers, 'index' as type, '4-2' as batch, 1 parllelmode, 1000 parallelsetupcost, 6 query, 0 i_q, 0 i_p, 0 i_s, 0 i_e, 0 i_d, 0 v_q, 0 v_s, 0 v_d, 100000 v_e, 0 v_p from lineitem where l_extendedprice > 99750 ;
select cast (count(l_extendedprice) as float)/59986052 selectivity, 0 workers, 'index' as type, '4-2' as batch, 1 parllelmode, 1000 parallelsetupcost, 6 query, 0 i_q, 0 i_p, 0 i_s, 0 i_e, 0 i_d, 0 v_q, 0 v_s, 0 v_d, 100000 v_e, 0 v_p from lineitem where l_extendedprice > 99500 ;
select cast (count(l_extendedprice) as float)/59986052 selectivity, 0 workers, 'index' as type, '4-2' as batch, 1 parllelmode, 1000 parallelsetupcost, 6 query, 0 i_q, 0 i_p, 0 i_s, 0 i_e, 0 i_d, 0 v_q, 0 v_s, 0 v_d, 100000 v_e, 0 v_p from lineitem where l_extendedprice > 99250 ;

select cast (count(l_extendedprice) as float)/59986052 selectivity, 0 workers, 'index' as type, '4-2' as batch, 1 parllelmode, 1000 parallelsetupcost, 6 query, 0 i_q, 0 i_p, 0 i_s, 0 i_e, 0 i_d, 0 v_q, 0 v_s, 0 v_d, 99000 v_e, 0 v_p from lineitem where l_extendedprice > 98750 ;
select cast (count(l_extendedprice) as float)/59986052 selectivity, 0 workers, 'index' as type, '4-2' as batch, 1 parllelmode, 1000 parallelsetupcost, 6 query, 0 i_q, 0 i_p, 0 i_s, 0 i_e, 0 i_d, 0 v_q, 0 v_s, 0 v_d, 97000 v_e, 0 v_p from lineitem where l_extendedprice > 96750 ;
select cast (count(l_extendedprice) as float)/59986052 selectivity, 0 workers, 'index' as type, '4-2' as batch, 1 parllelmode, 1000 parallelsetupcost, 6 query, 0 i_q, 0 i_p, 0 i_s, 0 i_e, 0 i_d, 0 v_q, 0 v_s, 0 v_d, 96000 v_e, 0 v_p from lineitem where l_extendedprice > 95750 ;
select cast (count(l_extendedprice) as float)/59986052 selectivity, 0 workers, 'index' as type, '4-2' as batch, 1 parllelmode, 1000 parallelsetupcost, 6 query, 0 i_q, 0 i_p, 0 i_s, 0 i_e, 0 i_d, 0 v_q, 0 v_s, 0 v_d, 99000 v_e, 0 v_p from lineitem where l_extendedprice > 98500 ;
select cast (count(l_extendedprice) as float)/59986052 selectivity, 0 workers, 'index' as type, '4-2' as batch, 1 parllelmode, 1000 parallelsetupcost, 6 query, 0 i_q, 0 i_p, 0 i_s, 0 i_e, 0 i_d, 0 v_q, 0 v_s, 0 v_d, 97000 v_e, 0 v_p from lineitem where l_extendedprice > 96500 ;
select cast (count(l_extendedprice) as float)/59986052 selectivity, 0 workers, 'index' as type, '4-2' as batch, 1 parllelmode, 1000 parallelsetupcost, 6 query, 0 i_q, 0 i_p, 0 i_s, 0 i_e, 0 i_d, 0 v_q, 0 v_s, 0 v_d, 96000 v_e, 0 v_p from lineitem where l_extendedprice > 95500 ;
\o
\timing off

\o | cat - >> /home/ubuntu/export/test5-explain.txt
explain select cast (count(l_extendedprice) as float)/59986052 selectivity, 0 workers, 'index' as type, '4-2' as batch, 1 parllelmode, 1000 parallelsetupcost, 6 query, 0 i_q, 0 i_p, 0 i_s, 0 i_e, 0 i_d, 0 v_q, 0 v_s, 0 v_d, 100000 v_e, 0 v_p from lineitem where l_extendedprice > 100000 ;
explain select cast (count(l_extendedprice) as float)/59986052 selectivity, 0 workers, 'index' as type, '4-2' as batch, 1 parllelmode, 1000 parallelsetupcost, 6 query, 0 i_q, 0 i_p, 0 i_s, 0 i_e, 0 i_d, 0 v_q, 0 v_s, 0 v_d, 99000 v_e, 0 v_p from lineitem where l_extendedprice > 99000 ;
explain select cast (count(l_extendedprice) as float)/59986052 selectivity, 0 workers, 'index' as type, '4-2' as batch, 1 parllelmode, 1000 parallelsetupcost, 6 query, 0 i_q, 0 i_p, 0 i_s, 0 i_e, 0 i_d, 0 v_q, 0 v_s, 0 v_d, 97000 v_e, 0 v_p from lineitem where l_extendedprice > 97000 ;
explain select cast (count(l_extendedprice) as float)/59986052 selectivity, 0 workers, 'index' as type, '4-2' as batch, 1 parllelmode, 1000 parallelsetupcost, 6 query, 0 i_q, 0 i_p, 0 i_s, 0 i_e, 0 i_d, 0 v_q, 0 v_s, 0 v_d, 96000 v_e, 0 v_p from lineitem where l_extendedprice > 96000 ;
explain select cast (count(l_extendedprice) as float)/59986052 selectivity, 0 workers, 'index' as type, '4-2' as batch, 1 parllelmode, 1000 parallelsetupcost, 6 query, 0 i_q, 0 i_p, 0 i_s, 0 i_e, 0 i_d, 0 v_q, 0 v_s, 0 v_d, 96000 v_e, 0 v_p from lineitem where l_extendedprice > 95000 ;
--variations
explain select cast (count(l_extendedprice) as float)/59986052 selectivity, 0 workers, 'index' as type, '4-2' as batch, 1 parllelmode, 1000 parallelsetupcost, 6 query, 0 i_q, 0 i_p, 0 i_s, 0 i_e, 0 i_d, 0 v_q, 0 v_s, 0 v_d, 100000 v_e, 0 v_p from lineitem where l_extendedprice > 99750 ;
explain select cast (count(l_extendedprice) as float)/59986052 selectivity, 0 workers, 'index' as type, '4-2' as batch, 1 parllelmode, 1000 parallelsetupcost, 6 query, 0 i_q, 0 i_p, 0 i_s, 0 i_e, 0 i_d, 0 v_q, 0 v_s, 0 v_d, 100000 v_e, 0 v_p from lineitem where l_extendedprice > 99500 ;
explain select cast (count(l_extendedprice) as float)/59986052 selectivity, 0 workers, 'index' as type, '4-2' as batch, 1 parllelmode, 1000 parallelsetupcost, 6 query, 0 i_q, 0 i_p, 0 i_s, 0 i_e, 0 i_d, 0 v_q, 0 v_s, 0 v_d, 100000 v_e, 0 v_p from lineitem where l_extendedprice > 99250 ;

explain select cast (count(l_extendedprice) as float)/59986052 selectivity, 0 workers, 'index' as type, '4-2' as batch, 1 parllelmode, 1000 parallelsetupcost, 6 query, 0 i_q, 0 i_p, 0 i_s, 0 i_e, 0 i_d, 0 v_q, 0 v_s, 0 v_d, 99000 v_e, 0 v_p from lineitem where l_extendedprice > 98750 ;
explain select cast (count(l_extendedprice) as float)/59986052 selectivity, 0 workers, 'index' as type, '4-2' as batch, 1 parllelmode, 1000 parallelsetupcost, 6 query, 0 i_q, 0 i_p, 0 i_s, 0 i_e, 0 i_d, 0 v_q, 0 v_s, 0 v_d, 97000 v_e, 0 v_p from lineitem where l_extendedprice > 96750 ;
explain select cast (count(l_extendedprice) as float)/59986052 selectivity, 0 workers, 'index' as type, '4-2' as batch, 1 parllelmode, 1000 parallelsetupcost, 6 query, 0 i_q, 0 i_p, 0 i_s, 0 i_e, 0 i_d, 0 v_q, 0 v_s, 0 v_d, 96000 v_e, 0 v_p from lineitem where l_extendedprice > 95750 ;
explain select cast (count(l_extendedprice) as float)/59986052 selectivity, 0 workers, 'index' as type, '4-2' as batch, 1 parllelmode, 1000 parallelsetupcost, 6 query, 0 i_q, 0 i_p, 0 i_s, 0 i_e, 0 i_d, 0 v_q, 0 v_s, 0 v_d, 99000 v_e, 0 v_p from lineitem where l_extendedprice > 98500 ;
explain select cast (count(l_extendedprice) as float)/59986052 selectivity, 0 workers, 'index' as type, '4-2' as batch, 1 parllelmode, 1000 parallelsetupcost, 6 query, 0 i_q, 0 i_p, 0 i_s, 0 i_e, 0 i_d, 0 v_q, 0 v_s, 0 v_d, 97000 v_e, 0 v_p from lineitem where l_extendedprice > 96500 ;
explain select cast (count(l_extendedprice) as float)/59986052 selectivity, 0 workers, 'index' as type, '4-2' as batch, 1 parllelmode, 1000 parallelsetupcost, 6 query, 0 i_q, 0 i_p, 0 i_s, 0 i_e, 0 i_d, 0 v_q, 0 v_s, 0 v_d, 96000 v_e, 0 v_p from lineitem where l_extendedprice > 95500 ;
\o
...
\o | cat - >> /home/ubuntu/export/test5-results.txt
\timing on
select cast (count(l_extendedprice) as float)/59986052 selectivity, 0 workers, 'index' as type, '4-3' as batch, 1 parllelmode, 1000 parallelsetupcost, 6 query, 0 i_q, 0 i_p, 0 i_s, 1 i_e, 0 i_d, 0 v_q, 0 v_s, 0 v_d, 94000 v_e, 0 v_p from lineitem where l_extendedprice > 94000 ;
select cast (count(l_extendedprice) as float)/59986052 selectivity, 0 workers, 'index' as type, '4-3' as batch, 1 parllelmode, 1000 parallelsetupcost, 6 query, 0 i_q, 0 i_p, 0 i_s, 1 i_e, 0 i_d, 0 v_q, 0 v_s, 0 v_d, 93000 v_e, 0 v_p from lineitem where l_extendedprice > 93000 ;

--variations
select cast (count(l_extendedprice) as float)/59986052 selectivity, 0 workers, 'index' as type, '4-3' as batch, 1 parllelmode, 1000 parallelsetupcost, 6 query, 0 i_q, 0 i_p, 0 i_s, 1 i_e, 0 i_d, 0 v_q, 0 v_s, 0 v_d, 94000 v_e, 0 v_p from lineitem where l_extendedprice > 94500 ;
select cast (count(l_extendedprice) as float)/59986052 selectivity, 0 workers, 'index' as type, '4-3' as batch, 1 parllelmode, 1000 parallelsetupcost, 6 query, 0 i_q, 0 i_p, 0 i_s, 1 i_e, 0 i_d, 0 v_q, 0 v_s, 0 v_d, 93000 v_e, 0 v_p from lineitem where l_extendedprice > 92500 ;
\o
\timing off

\o | cat - >> /home/ubuntu/export/test5-explain.txt
explain select cast (count(l_extendedprice) as float)/59986052 selectivity, 0 workers, 'index' as type, '4-3' as batch, 1 parllelmode, 1000 parallelsetupcost, 6 query, 0 i_q, 0 i_p, 0 i_s, 1 i_e, 0 i_d, 0 v_q, 0 v_s, 0 v_d, 94000 v_e, 0 v_p from lineitem where l_extendedprice > 94000 ;
explain select cast (count(l_extendedprice) as float)/59986052 selectivity, 0 workers, 'index' as type, '4-3' as batch, 1 parllelmode, 1000 parallelsetupcost, 6 query, 0 i_q, 0 i_p, 0 i_s, 1 i_e, 0 i_d, 0 v_q, 0 v_s, 0 v_d, 93000 v_e, 0 v_p from lineitem where l_extendedprice > 93000 ;

--variations
explain select cast (count(l_extendedprice) as float)/59986052 selectivity, 0 workers, 'index' as type, '4-3' as batch, 1 parllelmode, 1000 parallelsetupcost, 6 query, 0 i_q, 0 i_p, 0 i_s, 1 i_e, 0 i_d, 0 v_q, 0 v_s, 0 v_d, 94000 v_e, 0 v_p from lineitem where l_extendedprice > 94500 ;
explain select cast (count(l_extendedprice) as float)/59986052 selectivity, 0 workers, 'index' as type, '4-3' as batch, 1 parllelmode, 1000 parallelsetupcost, 6 query, 0 i_q, 0 i_p, 0 i_s, 1 i_e, 0 i_d, 0 v_q, 0 v_s, 0 v_d, 93000 v_e, 0 v_p from lineitem where l_extendedprice > 92500 ;
\o
...
explain select cast (count(l_extendedprice) as float)/59986052 selectivity, 0 workers, 'index' as type, '3-17' as batch, 0 parllelmode, 1000000 parallelsetupcost, 15 query, 0 i_q, 1 i_p, 1 i_s, 1 i_e, 0 i_d, 0 v_q, 56000 v_s, 0 v_d, 81000 v_e, 1200000 v_p from lineitem where l_extendedprice > 95000 and l_suppkey < 69000 and l_partkey < 1200000;
...
explain select cast (count(l_extendedprice) as float)/59986052 selectivity, 0 workers, 'index' as type, '3-17' as batch, 0 parllelmode, 1000000 parallelsetupcost, 15 query, 0 i_q, 1 i_p, 1 i_s, 1 i_e, 0 i_d, 0 v_q, 56000 v_s, 0 v_d, 81000 v_e, 1200000 v_p from lineitem where l_extendedprice > 94500 and l_suppkey < 69000 and l_partkey < 1200000;
\o
